...
#ifndef HOUGENAPP_SWIFT_H
#define HOUGENAPP_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="hougenapp",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC9hougenapp11AppDelegate")
...
SWIFT_CLASS("_TtC9hougenapp17MainFlutterWindow")
